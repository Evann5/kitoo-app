...
export function ChatFab() {
  ...
  return (
    <Link
      ...
      data-chat-fab
      className="bg-brand-700 shadow-brand hover:bg-brand-800 motion-safe:animate-enter fixed right-4 bottom-24 z-40 grid h-14 w-14 place-items-center rounded-full text-white ring-2 ring-white/80 motion-safe:active:scale-95"
